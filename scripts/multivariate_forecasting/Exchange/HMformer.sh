...
teacher_path_template=${TEACHER_PATH_TEMPLATE:-./checkpoints/Exchange_96___PRED_LEN___feedback_dynamic_ema_sl336_ll48_pl__PRED_LEN___dm128_nh16_el2_gl3_df128_ebtimeF_itr0/checkpoint.pth}
