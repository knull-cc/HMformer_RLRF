...
teacher_path_template=${TEACHER_PATH_TEMPLATE:-./checkpoints/ETTm1_96___PRED_LEN___feedback_dynamic_ema_sl336_ll48_pl__PRED_LEN___dm128_nh16_el2_gl3_df128_ebtimeF_itr0/checkpoint.pth}
...
run_ettm1() {
  ...
  echo "---------- start ETTm1_96_${pred_len}_${exp_suffix} ----------"
  ...
  python -u main.py \
    ...
    --data_path ETTm1.csv \
    --model_id ETTm1_96_${pred_len}_${exp_suffix} \
    --model HMformer \
    --data ett_m \
    --features M \
    --freq t \
  ...
  echo "---------- done ETTm1_96_${pred_len}_${exp_suffix} ----------"
