...
teacher_path_template=${TEACHER_PATH_TEMPLATE:-./checkpoints/ETTh2_96___PRED_LEN___feedback_dynamic_ema_sl336_ll48_pl__PRED_LEN___dm128_nh16_el2_gl3_df128_ebtimeF_itr0/checkpoint.pth}
...
run_etth2() {
  ...
  echo "---------- start ETTh2_96_${pred_len}_${exp_suffix} ----------"
  ...
  python -u main.py \
    ...
    --data_path ETTh2.csv \
    --model_id ETTh2_96_${pred_len}_${exp_suffix} \
    --model HMformer \
    --data ett_h \
    --features M \
    --freq 0 \
  ...
  echo "---------- done ETTh2_96_${pred_len}_${exp_suffix} ----------"
