...
teacher_path_template=${TEACHER_PATH_TEMPLATE:-./checkpoints/weather_96___PRED_LEN___feedback_dynamic_ema_sl336_ll48_pl__PRED_LEN___dm512_nh16_el3_gl3_df512_ebtimeF_itr0/checkpoint.pth}
